...
from funcoes_mestre import BlocoIntervalo, criar_blocos_ordenados, enviar_json, intercalar_baixo_alto, receber_json
...
class Mestre:
    ...
    def despachar_se_possivel(self, trabalhador: ConexaoTrabalhador) -> None:
        with self.trava:
            ...
            metadados = MetadadosTarefa(id_tarefa, trabalhador.id_trabalhador, intervalos, self.argumentos.modo, trabalhador.janela, time.perf_counter())
