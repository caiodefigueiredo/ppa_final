...
def criar_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument('--max-trabalhadores', dest='max_trabalhadores', type=int, default=30)
    parser.add_argument('--min-trabalhadores', dest='min_trabalhadores', type=int, default=1)
    parser.add_argument('--tempo-espera-trabalhadores', dest='tempo_espera_trabalhadores', type=float, default=30.0)
    parser.add_argument('--timeout-heartbeat', dest='timeout_heartbeat', type=float, default=180.0)
    parser.add_argument('--intervalo-monitoramento-heartbeat', dest='intervalo_monitoramento_heartbeat', type=float, default=5.0)
    ...
    parser.add_argument('--janela-maxima', dest='janela_maxima', type=float, default=100.0)
    parser.add_argument('--passo-aditivo', dest='passo_aditivo', type=float, default=2.0)
    parser.add_argument('--fator-reducao', dest='fator_reducao', type=float, default=0.5)
    parser.add_argument('--tempo-alvo', dest='tempo_alvo', type=float, default=2.0)
